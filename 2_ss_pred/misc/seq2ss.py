...
if os.getcwd() == '/home/enno/uni/SS23/thesis':
    ...
    file_path = '/ebio/abt1_share/prediction_hendecads/0_data/2_ss_pred/seq.csv'
...
if __name__ == '__main__':
    ...
    plot_prediction(y_pred, y_test[1:2], fig_path='/ebio/abt1_share/prediction_hendecads/0_data/2_ss_pred/plot_pred.png')
    plot_confusion_matrix(1, y_pred, y_test[1:2], fig_path='/ebio/abt1_share/prediction_hendecads/0_data/2_ss_pred/plot_cm.png')
